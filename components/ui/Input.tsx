...
export const Input: React.FC<InputProps> = ({ label, prefix, suffix, tooltip, className, ...props }) => {
  return (
      ...
      <div className="relative group">
        ...
        <input
          ...
          className={`
            ...
            py-2 ${prefix ? 'pl-10' : 'pl-4'} ${suffix ? 'pr-10' : 'pr-4'} 
        ...
        />
        {suffix && (
          <span className="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-500 font-mono text-lg z-10">
            {suffix}
          </span>
        )}
